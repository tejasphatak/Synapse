...
└── test/               # 860 tests — full coverage across protocol, binary, pipeline, shard-loader, node, generation, topology, routing, pruning, P2P, adaptive precision, entropy, mixture-of-depths, KV cache, tensor serializer, log store, coordinator HTTP APIs, batch speculation
```
